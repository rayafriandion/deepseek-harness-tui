...
export class Terminal extends EventEmitter {
  ...
  stop() {
    ...
    // Show cursor, leave alternate screen, reset.
    this.write('\x1b[?25h\x1b[0m\x1b[?1049l')
    this.raw = false
  }
  ...
  paint(screen) {
    ...
    // Move cursor to the input position (bottom-left) after painting.
    this.write('\x1b[' + screen.rows + ';1H')
  }
}
